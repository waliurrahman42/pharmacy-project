...
<body>
	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark p-0">
		<div class="container">
			<a href="/admin" class="navbar-brand bg-white my-1"> <img
				src="/image/logo.png" alt="@logo" height="40px" width="auto">
			</a> <a href="/admin" class="navbar-brand">AdminPannel</a>
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav">
					<li class="nav-item px-2"><a href="/admin"
						class="nav-link active">Dashboard</a></li>
					<li class="nav-item px-2"><a href="/seller" class="nav-link">Seller</a>
					</li>
					<li class="nav-item px-2"><a href="/medicinemaster"
