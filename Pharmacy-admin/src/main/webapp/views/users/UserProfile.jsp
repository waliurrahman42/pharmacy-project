        ...
        <div class="row gutters">
            ...
            <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                <div class=" row card h-80">
                    ...
                    <div class="card h-80 address-section <c:if test="${!editAddForm}">collapse</c:if> " id="address-section">
                        <div class="add-address ml-3 mr-3 mb-3 mt-3">
                            <button  data-toggle="collapse" data-target="#input-address-section"></i>Add new Address</button>
                        </div>
                                ...
                                <form  action="saveUserAdd"  method="post" >
                                 ...
                                 <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="localityAreaStreet"   value="${editAddFormDetails.localityAreaStreet}"   id="address" 
                                                rows="5" cols="10">
                                                </textarea>
                                        </div>
                                  </div> 
