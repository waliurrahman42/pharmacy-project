...
<body>
	...
	<div class="cart p-4">
		...
		<div class="row">
			<div class="col-sm-8">
				<h3
					style="height: 50px; line-height: 50px; background-color: rgb(190, 231, 231); padding-left: 1%;">
					Your Cart (<span id="your-cart">0</span>)
				</h3>
				<hr
					style="height: 5px; box-shadow: inset 0 9px 90px -30px rgba(5, 73, 136, 0.8);">
				<!-- <br> -->
				<div id="empty-cart">
			...
			<div class="col-sm-4">
				<div class="checkout-section">
					Total Price: <span id="total">0</span> <br> Delivery Cost:<span
						id="delivery-fee">0</span> <br> Discount: <span id="discount">0</span>
					<hr>
