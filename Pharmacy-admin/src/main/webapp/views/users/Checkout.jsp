		...
		<div class="row  ">
			...
			<div class="card h-80  " id="">
				...
				<div class="<c:if test="${!editAddForm}">collapse</c:if> mx-5 "
					...
					<form action="saveUserAddressCheckout" method="post">
						<div class="col-10">
							...
							<input type="text" name="user" value="${userdetails.userId}"
						...
						<div class="col-10">
							<div class="form-group">
								...
								<textarea class="form-control" name="localityAreaStreet"
									id="address" rows="5" cols="10">${editAddFormDetails.localityAreaStreet}
                                       </textarea>
							</div>
						</div>
						...
						<div class="  col-9">
							<c:if test="${!editAddForm}">
								<input type="submit"
									class="save-address-btn btn btn-primary float-right"
									value="submit">
							</c:if>
							<c:if test="${editAddForm}">
				...
				<c:forEach var="address" items="${userdetails.userAddresses }">
					<div
						class="user-address-section row justify-content-center   mt-3 ml-3 mb-2 mr-3 ">
						<div id=" radio address-radio col-2 ">
							<input type="radio" class="m-1" value="current"
								name="address-sel" id="address-sel" checked>
						</div>
						<div class="px-4 py-1 addressprint col-8 ">
							<span class="">${address.name}</span> &nbsp;<br> <span
								class="">${address.mobileNumber}</span> <br> <span class="">${address.localityAreaStreet}</span>
