            ...
            <div class="card-body">
              <form method="post" action="/addSeller">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="emailId" class="form-control" placeholder="Enter Email" name="email"
                    id="email" required />
                </div>

                <div class="form-group">
                  <label for="psw"><b>Password</b></label>
                  <input type="password" name="password" class="form-control" placeholder="Enter Password" name="psw"
                    id="psw" required />
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="repassword" class="form-control" placeholder="ReEnter Password"
                    name="psw-reEnter" id="psw-reEnter" required />
                </div>

                <div class="form-group">
                  <label for="ShopName"><b>ShopName</b></label>
                  <input type="text" name="shopName" class="form-control" placeholder="Enter ShopName" name="ShopName"
                    id="ShopName" required />
                </div>

                <div class="form-group">
                  <label for="ShopRegNo"><b>ShopRegNo</b></label>
                  <input type="text" name="shopeRegNo" class="form-control" placeholder="EnterShopRegNo "
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="shopAddress" class="form-control" placeholder=" ShopAddress"
                    name="ShopAddress" id="ShopAddress" required />
                </div>

                <div class="form-group">
                  <label for="ShopPincode"><b>Enter a ShopPincode:</b></label>
                  <input type="text" name="shopPincode" class="form-control" placeholder="Shop Pin code"
