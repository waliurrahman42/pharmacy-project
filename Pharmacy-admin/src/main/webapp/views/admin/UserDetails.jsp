							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="form-group">
									<label for="fullName">Full Name</label> <input type="text"
										value="${currentuser.fullName}" class="form-control"
							...
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
								<div class="form-group">
									<label for="phone">Contact Number</label> <input type="text"
										value="${currentuser.contactNumber}" class="form-control"
						...
						<div class="<c:if test="${!editAddForm}">collapse</c:if>"
							...
							<form action="addaddress" method="post">
								<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
									...
									<input type="text" name="user" value="${currentuser.userId}"
							...
							<div class="user-address-section mt-3 ml-3 mb-3 mr-3 p-3">
								...
								<div class="right mr-5">
									...
									<a class="btn btn-success "
										href="/editAddress?userAId=${address.userAddressId}	"><i
